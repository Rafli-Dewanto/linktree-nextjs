...
function LinkCard({ href, title, image }) {
  return (
    <a href={href}
      className='flex items-center w-full p-1 rounded-md hover:scale-105 transition-all ease-in-out delay-75 hover:motion-reduce:animate-bounce duration-300 border border-gray-300 mb-3 bg-[#fff] max-w-3xl'
    >
      <div className='flex text-center w-full'>
        ...
        <h2 className='flex items-center justify-center font-normal w-full -ml-10'>{title}</h2>
      </div>
    </a>
  )
}
